...
}(); //anonymous closure (a function with no name that automatically executes as soon as its called)
    ...
    for (var i=0; i<myNodes.length; i++) {
        myNodes[i].addEventListener("click", function(e) {
            if ("IMG" === e.target.tagName) {
	            ...
	            myOverlay.id = "overlay", document.body.appendChild(myOverlay), 
                ...
                largeImage.id = "largeImage", 
                	...
                	largeImage.addEventListener("load", function() {
                    	this.height > window.innerHeight && (this.ratio = window.innerHeight / this.height, 
                    		this.height = this.height * this.ratio, this.width = this.width * this.ratio), 
